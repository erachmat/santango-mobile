        ...
        slivers: [
          SliverAppBar(
            ...
            bottom: PreferredSize(
              ...
              child: Container(
                child: Center(child: BigText(text: product.menuName!, size: Dimensions.font26,)),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  BigText(text: "\Rp ${product.price!} X ${controller.inCartItems}", color: AppColor.mainBlackColor, size: Dimensions.font26,),
                  GestureDetector(
                    onTap: (){
